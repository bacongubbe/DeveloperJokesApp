...
class JokeRepository {
  ...
  init {
      repo += listOf(
        ...
        Joke("Varför har Javautvecklare glasögon? De kan inte C",
          UUID.fromString("b55a8632-bb9e-4c9d-9581-8b474fce8878"), "se"),
        Joke("Jag är specialist på Microsofts alkoholprogram, alltså en systemvetare.",
  ...
  fun getSpecificJoke(id : String ) : Joke {
    validateUUID(id)
    return repo.stream().filter { it.id == UUID.fromString(id) }.findFirst()
